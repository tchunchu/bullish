'use strict';
/**
 * quality.cjs — Deterministic quality & scoring engine (InvestSkill-inspired).
 *
 * WHY THIS EXISTS
 ...
 * ROIC/WACC/IC come from valuation.cjs so this stays consistent with the headline spread.
 */
...
function compositeScore(m = {}, weightsOverride = null) {
  ...
  // ---- weights
  // Regime-adaptive weights: pass regime.weights from lib/regime.cjs to make the
