#!/usr/bin/env node
/**
 * render_v5.cjs  — Deterministic HTML renderer.
 *
 ...
 *
 * Usage:
 *   node screener/render_v5.cjs                          # uses files in screener/
 *   node screener/render_v5.cjs --pass2=path/to/p2.json # override pass2 path
 *
...
if (!fs.existsSync(DUMP_PATH)) {
  console.error(`❌ render_v5: missing ${DUMP_PATH}  — run screener_v5.cjs first`);
  process.exit(1);
}
...
<div class="container">
  ...
  <div class="subtitle">
    ...
    &nbsp;|&nbsp; Renderer: <code>render_v5.cjs</code> (deterministic)
  </div>
  ...
  <div class="footer">
    ...
    Forward returns tracked in <code>screener_log.jsonl</code> via <code>scorecard.cjs</code>.
  </div>
