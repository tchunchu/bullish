#!/usr/bin/env node
/**
 * lint_pass2.js — HARD GATE for LLM Pass-2 output.
 *
 * MUST exit 0 before render_v5.js is allowed to run.
...
if (errors.length) {
  ...
  console.error('\n→ Fix pass2.json and rerun lint before calling render_v5.js.\n');
  process.exit(1);
}

console.log(`✅ lint_pass2: ${pass2.length} rows clean — proceed to render_v5.js`);
